...
?>
<li class="ui-state-default wells" data-path="<?= $entities->path; ?>" id="menus-<?= $count ?>" data-model="<?= $className ?>"  data-alias="<?= $entities->alias ?>" data-title='<?= $entities->title ?>' data-depth="0" data-item="0" >
